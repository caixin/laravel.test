...
CREATE TABLE `bc_admin` (
  ...
  `password` varchar(60) NOT NULL DEFAULT '' COMMENT '密碼',
  `mobile` char(11) NOT NULL DEFAULT '' COMMENT '手機號碼',
  `roleid` int(11) NOT NULL DEFAULT '0' COMMENT '角色ID',
  `login_ip` varchar(16) NOT NULL DEFAULT '' COMMENT '登入IP',
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='系統帳號';
...
CREATE TABLE `bc_admin_action_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2290 DEFAULT CHARSET=utf8 COMMENT='系統帳號操作LOG';
...
CREATE TABLE `bc_admin_login_log` (
  ...
  `adminid` int(11) NOT NULL DEFAULT '0' COMMENT 'adminid',
  `ip` varchar(16) NOT NULL DEFAULT '' COMMENT '登入IP',
  `ip_info` text NOT NULL COMMENT 'IP資訊',
  `create_time` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '建檔時間',
  `create_by` varchar(30) NOT NULL DEFAULT '' COMMENT '新增者',
  PRIMARY KEY (`id`),
  KEY `create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=789 DEFAULT CHARSET=utf8 COMMENT='系統帳號登入LOG';
...
CREATE TABLE `bc_admin_nav` (
  ...
  `route` varchar(100) NOT NULL DEFAULT '' COMMENT '主路由',
  `route1` varchar(100) NOT NULL DEFAULT '' COMMENT '次路由',
  `route2` varchar(100) NOT NULL DEFAULT '' COMMENT '次路由',
...
CREATE TABLE `bc_admin_role` (
  ...
  `update_by` varchar(30) NOT NULL DEFAULT '' COMMENT '更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='系統帳號角色權限';
...
#
# Structure for table "bc_ip2location"
#

CREATE TABLE `bc_ip2location` (
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8 COMMENT='用戶列表';
